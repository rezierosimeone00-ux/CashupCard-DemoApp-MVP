    ...
    <main className="bg-gray-50 min-h-screen font-sans">
      ...
      <section className="max-w-6xl mx-auto p-10">
        <div className="bg-gradient-to-r from-gray-900 to-gray-800 text-white px-6 py-4 rounded-2xl mb-8 shadow-md">
          ...
          <p className="text-sm text-gray-300">
            Dataset target 83,333 pop · cap 3% → ~2,500 cards · 25% uplift
            (Pay 80 / Get 100)
          </p>
        </div>
        ...
        <div className="grid grid-cols-6 gap-4 mb-12">
          {kpi.map((m) => (
            <div
              key={m.id}
              className="rounded-xl bg-white border border-gray-300 p-5 text-center shadow hover:shadow-lg transition"
            >
        ...
        <p className="text-xs text-gray-500 mb-12">
          Cap = percentuale massima di carte emettibili rispetto alla
        ...
        <div className="grid grid-cols-3 gap-4">
          {agents.map((a) => (
            <div
              key={a.id}
              className="rounded-xl bg-white border border-gray-300 p-5 shadow hover:shadow-lg transition"
            >
